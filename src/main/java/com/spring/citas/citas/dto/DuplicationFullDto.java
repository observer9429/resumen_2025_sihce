...
public class DuplicationFullDto {
    ...
    public DuplicationFullDto() {}

    public DuplicationFullDto(
            Long id,
            Long codEess,
            String nombreEess,
            String descripcionDelServicio,
            String profesionalDeLaSalud,
            String consultorio,
            String turno,
            String fechaDeCita,
            Long diaCita,
            ...
            String mesAtencion,
            Long anoCita,
            String horaInicialCita,
            String tipoDeCupo,
            String estadoDeLaCita,
            ...
            String nombresDelPaciente,
            String apellidoPaternoDelPaciente,
            String apellidoMaternoDelPaciente,
            String celular,
            String genero,
            Long personalQueCita,
            String usuarioCc
    ) {
        ...
        this.profesionalDeLaSalud = profesionalDeLaSalud;
        ...
        this.anoCita = anoCita;
        this.horaInicialCita = horaInicialCita;
        this.tipoDeCupo = tipoDeCupo;
        ...
        this.apellidoMaternoDelPaciente = apellidoMaternoDelPaciente;
        this.celular = celular;
        this.genero = genero;
        this.personalQueCita = personalQueCita;
    ...
    public Long getCodEess() {
        return codEess;
    }

    public void setCodEess(Long codEess) {
        this.codEess = codEess;
    }
    ...
    public String getProfesionalDeLaSalud() {
        return profesionalDeLaSalud;
    }

    public void setProfesionalDeLaSalud(String profesionalDeLaSalud) {
        this.profesionalDeLaSalud = profesionalDeLaSalud;
    }
    ...
    public Long getDiaCita() {
        return diaCita;
    }

    public void setDiaCita(Long diaCita) {
        this.diaCita = diaCita;
    }

    public Long getMesCita() {
        return mesCita;
    }

    public void setMesCita(Long mesCita) {
        this.mesCita = mesCita;
    }
    ...
    public Long getAnoCita() {
        return anoCita;
    }

    public void setAnoCita(Long anoCita) {
        this.anoCita = anoCita;
    }

    public String getHoraInicialCita() {
        return horaInicialCita;
    }
    ...
    public String getTipoDeCupo() {
        return tipoDeCupo;
    }

    public void setTipoDeCupo(String tipoDeCupo) {
        this.tipoDeCupo = tipoDeCupo;
    }
    ...
    public Long getDiaCreacion() {
        return diaCreacion;
    }

    public void setDiaCreacion(Long diaCreacion) {
        this.diaCreacion = diaCreacion;
    }

    public Long getMesCreacion() {
        return mesCreacion;
    }

    public void setMesCreacion(Long mesCreacion) {
        this.mesCreacion = mesCreacion;
    }

    public Long getAnoCreacion() {
        return anoCreacion;
    }

    public void setAnoCreacion(Long anoCreacion) {
        this.anoCreacion = anoCreacion;
    }
    ...
    public String getApellidoMaternoDelPaciente() {
        return apellidoMaternoDelPaciente;
    }

    public void setApellidoMaternoDelPaciente(String apellidoMaternoDelPaciente) {
        this.apellidoMaternoDelPaciente = apellidoMaternoDelPaciente;
    }
    ...
    public Long getPersonalQueCita() {
        return personalQueCita;
    }

    public void setPersonalQueCita(Long personalQueCita) {
        this.personalQueCita = personalQueCita;
    }
